...
type MetadataApiDeleteArtifactVersionMetaDataRequest struct {
	ctx context.Context
...
func (r MetadataApiDeleteArtifactVersionMetaDataRequest) Execute() (*http.Response, error) {
...
* A server error occurred (HTTP error `500`)
 ...
 @return MetadataApiDeleteArtifactVersionMetaDataRequest
*/
func (a *MetadataApiService) DeleteArtifactVersionMetaData(ctx context.Context, groupId string, artifactId string, version string) MetadataApiDeleteArtifactVersionMetaDataRequest {
	return MetadataApiDeleteArtifactVersionMetaDataRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
func (a *MetadataApiService) DeleteArtifactVersionMetaDataExecute(r MetadataApiDeleteArtifactVersionMetaDataRequest) (*http.Response, error) {
	var (
...
type MetadataApiGetArtifactMetaDataRequest struct {
	ctx context.Context
	ApiService *MetadataApiService
	groupId string
	artifactId string
...
func (r MetadataApiGetArtifactMetaDataRequest) Execute() (*ArtifactMetaData, *http.Response, error) {
...
* A server error occurred (HTTP error `500`)
 ...
 @param groupId The artifact group ID.  Must be a string provided by the client, representing the name of the grouping of artifacts.
 @param artifactId The artifact ID.  Can be a string (client-provided) or UUID (server-generated), representing the unique artifact identifier.
 @return MetadataApiGetArtifactMetaDataRequest
*/
func (a *MetadataApiService) GetArtifactMetaData(ctx context.Context, groupId string, artifactId string) MetadataApiGetArtifactMetaDataRequest {
	return MetadataApiGetArtifactMetaDataRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
func (a *MetadataApiService) GetArtifactMetaDataExecute(r MetadataApiGetArtifactMetaDataRequest) (*ArtifactMetaData, *http.Response, error) {
	var (
...
type MetadataApiGetArtifactVersionMetaDataRequest struct {
	ctx context.Context
	ApiService *MetadataApiService
	groupId string
	artifactId string
...
func (r MetadataApiGetArtifactVersionMetaDataRequest) Execute() (*VersionMetaData, *http.Response, error) {
...
* A server error occurred (HTTP error `500`)
 ...
 @param artifactId The artifact ID.  Can be a string (client-provided) or UUID (server-generated), representing the unique artifact identifier.
 @param version The unique identifier of a specific version of the artifact content.
 @return MetadataApiGetArtifactVersionMetaDataRequest
*/
func (a *MetadataApiService) GetArtifactVersionMetaData(ctx context.Context, groupId string, artifactId string, version string) MetadataApiGetArtifactVersionMetaDataRequest {
	return MetadataApiGetArtifactVersionMetaDataRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
func (a *MetadataApiService) GetArtifactVersionMetaDataExecute(r MetadataApiGetArtifactVersionMetaDataRequest) (*VersionMetaData, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type MetadataApiGetArtifactVersionMetaDataByContentRequest struct {
	ctx context.Context
	ApiService *MetadataApiService
	groupId string
	artifactId string
...
func (r MetadataApiGetArtifactVersionMetaDataByContentRequest) Body(body interface{}) MetadataApiGetArtifactVersionMetaDataByContentRequest {
	r.body = &body
	return r
}
...
func (r MetadataApiGetArtifactVersionMetaDataByContentRequest) Canonical(canonical bool) MetadataApiGetArtifactVersionMetaDataByContentRequest {
	r.canonical = &canonical
	return r
}

func (r MetadataApiGetArtifactVersionMetaDataByContentRequest) Execute() (*VersionMetaData, *http.Response, error) {
...
* A server error occurred (HTTP error `500`)
 ...
 @param groupId The artifact group ID.  Must be a string provided by the client, representing the name of the grouping of artifacts.
 @param artifactId The artifact ID.  Can be a string (client-provided) or UUID (server-generated), representing the unique artifact identifier.
 @return MetadataApiGetArtifactVersionMetaDataByContentRequest
*/
func (a *MetadataApiService) GetArtifactVersionMetaDataByContent(ctx context.Context, groupId string, artifactId string) MetadataApiGetArtifactVersionMetaDataByContentRequest {
	return MetadataApiGetArtifactVersionMetaDataByContentRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
//  @return VersionMetaData
func (a *MetadataApiService) GetArtifactVersionMetaDataByContentExecute(r MetadataApiGetArtifactVersionMetaDataByContentRequest) (*VersionMetaData, *http.Response, error) {
	var (
...
type MetadataApiUpdateArtifactMetaDataRequest struct {
	ctx context.Context
	ApiService *MetadataApiService
	groupId string
	artifactId string
...
func (r MetadataApiUpdateArtifactMetaDataRequest) EditableMetaData(editableMetaData EditableMetaData) MetadataApiUpdateArtifactMetaDataRequest {
	r.editableMetaData = &editableMetaData
	return r
}

func (r MetadataApiUpdateArtifactMetaDataRequest) Execute() (*http.Response, error) {
...
* A server error occurred (HTTP error `500`)
 ...
 @param groupId The artifact group ID.  Must be a string provided by the client, representing the name of the grouping of artifacts.
 @param artifactId The artifact ID.  Can be a string (client-provided) or UUID (server-generated), representing the unique artifact identifier.
 @return MetadataApiUpdateArtifactMetaDataRequest
*/
func (a *MetadataApiService) UpdateArtifactMetaData(ctx context.Context, groupId string, artifactId string) MetadataApiUpdateArtifactMetaDataRequest {
	return MetadataApiUpdateArtifactMetaDataRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
func (a *MetadataApiService) UpdateArtifactMetaDataExecute(r MetadataApiUpdateArtifactMetaDataRequest) (*http.Response, error) {
	var (
...
type MetadataApiUpdateArtifactVersionMetaDataRequest struct {
	ctx context.Context
	ApiService *MetadataApiService
	groupId string
	artifactId string
...
func (r MetadataApiUpdateArtifactVersionMetaDataRequest) EditableMetaData(editableMetaData EditableMetaData) MetadataApiUpdateArtifactVersionMetaDataRequest {
	r.editableMetaData = &editableMetaData
	return r
}

func (r MetadataApiUpdateArtifactVersionMetaDataRequest) Execute() (*http.Response, error) {
...
* A server error occurred (HTTP error `500`)
 ...
 @param artifactId The artifact ID.  Can be a string (client-provided) or UUID (server-generated), representing the unique artifact identifier.
 @param version The unique identifier of a specific version of the artifact content.
 @return MetadataApiUpdateArtifactVersionMetaDataRequest
*/
func (a *MetadataApiService) UpdateArtifactVersionMetaData(ctx context.Context, groupId string, artifactId string, version string) MetadataApiUpdateArtifactVersionMetaDataRequest {
	return MetadataApiUpdateArtifactVersionMetaDataRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
func (a *MetadataApiService) UpdateArtifactVersionMetaDataExecute(r MetadataApiUpdateArtifactVersionMetaDataRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
